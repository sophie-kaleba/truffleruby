...
public final class CallInternalMethodNodeAux extends CallInternalMethodNode {
    ...
    private CallInternalMethodNodeAux() {
    }
    ...
    public static CallInternalMethodNode create() {
        return new CallInternalMethodNodeAux();
    }

    public static CallInternalMethodNode getUncached() {
        return CallInternalMethodNodeAux.UNCACHED;
    }
