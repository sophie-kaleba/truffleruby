...
public final class LookupMethodNodeAux extends LookupMethodNode {
    ...
    public static LookupMethodNode create() {
        return new LookupMethodNodeAux();
    }

    public static LookupMethodNode getUncached() {
        return LookupMethodNodeAux.UNCACHED;
    }
