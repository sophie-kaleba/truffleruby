...
public final class CallInternalMethodNodeStatic extends CallInternalMethodNode {
    ...
    private CallInternalMethodNodeStatic() {
    }
    ...
    private Object executeAndSpecialize(Frame frameValue, InternalMethod arg0Value, Object arg1Value, Object[] arg2Value, LiteralCallNode arg3Value, RubyCallNode arg4Value) {
        ...
        try {
            ...
            try {
                if (((exclude & 0b1)) == 0 /* is-not-exclude callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */ && (isSingleContext())) {
                    int count0_ = 0;
                    CallCachedData s0_ = this.callCached_cache;
                    if ((state_0 & 0b1) != 0 /* is-state_0 callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */) {
                        while (s0_ != null) {
                                ...
                                if ((!(cachedMethod__.alwaysInlined()))) {
                                    ...
                                    if (Assumption.isValidAssumption(assumption0)) {
                                        if (count0_ < (getCacheLimit())) {
                                            ...
                                            this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */;
                                        }
                                    }
                                }
                            }
                ...
                if ((!(arg0Value.alwaysInlined()))) {
                    ...
                    this.exclude_ = exclude = exclude | 0b1 /* add-exclude callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */;
                    this.callCached_cache = null;
                    state_0 = state_0 & 0xfffffffe /* remove-state_0 callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */;
                                ...
                                if ((cachedMethod__1.alwaysInlined())) {
                                    ...
                                    if (Assumption.isValidAssumption(assumption0)) {
                                        if (count2_ < (getCacheLimit())) {
                                            ...
                                            this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 alwaysInlined(Frame, InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, AlwaysInlinedMethodNode, Arity, BranchProfile, BranchProfile) */;
                                        }
                                    }
                                }
                            }
                ...
                if ((arg0Value.alwaysInlined())) {
                    this.exclude_ = exclude = exclude | 0b10 /* add-exclude alwaysInlined(Frame, InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, AlwaysInlinedMethodNode, Arity, BranchProfile, BranchProfile) */;
                    this.alwaysInlined_cache = null;
                    state_0 = state_0 & 0xfffffffb /* remove-state_0 alwaysInlined(Frame, InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, AlwaysInlinedMethodNode, Arity, BranchProfile, BranchProfile) */;
    ...
    void removeCallCached_(Object s0_) {
        ...
        try {
            ...
            if (this.callCached_cache == null) {
                this.state_0_ = this.state_0_ & 0xfffffffe /* remove-state_0 callCached(InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, DirectCallNode) */;
            }
        } finally {
            lock.unlock();
        }
    ...
    void removeAlwaysInlined_(Object s2_) {
        ...
        try {
            ...
            if (this.alwaysInlined_cache == null) {
                this.state_0_ = this.state_0_ & 0xfffffffb /* remove-state_0 alwaysInlined(Frame, InternalMethod, Object, Object[], LiteralCallNode, RubyCallNode, RootCallTarget, InternalMethod, AlwaysInlinedMethodNode, Arity, BranchProfile, BranchProfile) */;
            }
        } finally {
            lock.unlock();
        }
    ...
    public static CallInternalMethodNode create() {
        return new CallInternalMethodNodeStatic();
    }

    public static CallInternalMethodNode getUncached() {
        return CallInternalMethodNodeStatic.UNCACHED;
    }
